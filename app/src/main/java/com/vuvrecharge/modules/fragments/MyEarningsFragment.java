...
public class MyEarningsFragment extends BaseFragment implements DefaultView {
    ...
    ImageView txtNoData;
    @BindView(R.id.myEarnings)
    RecyclerView myEarnings;
    ...
    public View provideYourFragmentView(@NonNull LayoutInflater inflater, ViewGroup parent, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_my_earnings, parent, false);
        ...
        mDefaultPresenter.myReferralIncome(device_id, page + "", "Yes", "earnings");
    ...
    private void initializeEventsList() {
        ...
        myEarnings.setHasFixedSize(true);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity(), RecyclerView.VERTICAL, false);
        myEarnings.setLayoutManager(linearLayoutManager);
        myEarnings.setAdapter(adapter);
        myEarnings.addOnScrollListener(new RecyclerView.OnScrollListener() {
            @Override
    ...
    public void onSuccess(String data, String data_other) {
        try {
            ...
            Log.d("TAG", "onSuccess earnings: " + jsonArray.toString());
            if (jsonArray.length() > 0) {
                ...
                myEarnings.setVisibility(View.VISIBLE);
            } else {
                txtNoData.setVisibility(View.VISIBLE);
                myEarnings.setVisibility(View.GONE);
            }
        } catch (Exception e) {
